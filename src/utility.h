...
#ifndef SWC_TETMESHER_UTILITY_H
#define SWC_TETMESHER_UTILITY_H
#include <fstream>
#include <iostream>
#include <string>
#include <vector>

inline bool string_replace(std::string &str, const std::string &from,
                           const std::string &to) {
...
inline bool getFileContent(std::string fileName,
