...
#ifndef SWC_TETMESHER_MORPH_H
#define SWC_TETMESHER_MORPH_H
...
struct BoundingBox3 {
  ...
  friend BoundingBox3 operator+(BoundingBox3 lhs, const BoundingBox3 &rhs) {
    lhs += rhs;
    return lhs;
  }
};
...
class Segment {
public:
  Segment(int start_point_idx, int end_point_type, PointR start_point,
          PointR end_point);
